...
class MatchVisitTemplate(ABC):
    ...
    def process_visit(self, player_index, visit):
        """
        returns reselt (0 meaning game goes on, >0 meaning a dart finished the game, response (info messages)
        Skeleton of operations to perform. DON'T override me.

        The Template Method defines a skeleton of an algorithm in an operation, and defers some step to subclasses.
        """
        ...
        # Note: this violate the separation of concerns principle (we are mixing presentation logic in)
    ...
    @abstractmethod
    def record_statistics(self, player_index, visit):
        """
        Primitive operation. You HAVE TO override me, I'm a placeholder
        """
        pass
